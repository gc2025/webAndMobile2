...
?>
   ...
   <p class = "lRp">
    ...
    <div claass="bullF">
        <img src="assets/pictures/bullEgg.png" alt="Tater Tots W/ Egg" class="bullF1">
        <img src="assets/pictures/bullNoodle.png" alt="Noodle Dish" class="bullF2">
        <img src="assets/pictures/bullWrap.png" alt="Club Wrap" class="bullF3">
    ...
    <p class = "lRp">
        ...
        <div class="boom">
            <img src="assets/pictures/boomCItyP.png" alt="Boom City Pretzel" class="boom1">
            <img src="assets/pictures/boomCityPizza.png" alt="Boom City Pretzel" class="boom2">
            <img src="assets/pictures/boomCSteak.png" alt="boom CIty Steak" class="boom3">
