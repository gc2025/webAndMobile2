...
?>
   <h1 class = "lh1">Local Theater/ Concert Venues</h1>
    <p class = "lp">
        In Williamsport we have a very big community for theater and major musical productions, And you can also see multiple concerts as well in the same location and in a different location as well.
        Here are two examples of where you can go to see local productions and major concerts as well:
    </p>
    ...
    <img src="assets/pictures/cac-outside.png" alt="CAC Outside View" class="cacO">
